...
export default {
    addItem({ commit }, item) {
        return new Promise((resolve, reject) => {
            axios
                .post("/api/skill-management/store", item)
                .then(response => {
                    commit(
                        "ADD_ITEM",
                        Object.assign(item, {
    ...
    updateItem({ commit }, item) {
        return new Promise((resolve, reject) => {
            axios
                .post(`/api/skill-management/update/${item.id}`, item)
                .then(response => {
    ...
    fetchItems({ commit }) {
        return new Promise((resolve, reject) => {
            axios
                .get("/api/skill-management/index")
                .then(response => {
    ...
    fetchItemByTaskId({ commit }, task_id) {
        return new Promise((resolve, reject) => {
            axios
                .get(`/api/skill-management/getByTaskId/${task_id}`)
                .then(response => {
                    resolve(response);
                })
                .catch(error => {
    ...
    restoreItem({ commit }, id) {
        return new Promise((resolve, reject) => {
            axios
                .put(`/api/skill-management/restore/${id}`)
                .then(response => {
    ...
    forceRemoveItem({ commit }, id) {
        return new Promise((resolve, reject) => {
            axios
                .delete(`/api/skill-management/forceDelete/${id}`)
                .then(response => {
                    if (response.data.success) {
