...
export default {
    addItem({ commit }, item) {
        return new Promise((resolve, reject) => {
            axios
                .post("/api/task-management/store", item)
                .then(response => {
    ...
    addComment({ commit }, item) {
        return new Promise((resolve, reject) => {
            axios
                .post(`/api/task-management/store-comment/${item.id}`, item)
                .then(response => {
                    commit(
                        "UPDATE_ITEM",
                        Object.assign(item, {
    ...
    addItemRange({ commit }, item) {
        return new Promise((resolve, reject) => {
            axios
                .post(
                    `/api/project-management/store-range/${item.rangeId}`,
                    item
                )
                .then(response => {
    ...
    updateItem({ commit }, item) {
        return new Promise((resolve, reject) => {
            axios
                .post(`/api/task-management/update/${item.id}`, item)
                .then(response => {
                    if (response.data.success) {
    ...
    fetchItemsByBundle({ commit }, bundle_id) {
        return new Promise((resolve, reject) => {
            axios
                .get(`/api/task-management/bundle/${bundle_id}`)
                .then(response => {
                    commit("SET_ITEMS", response.data.success);
                    resolve(response);
                })
    ...
    fetchItemsBySkill({ commit }, skill_id) {
        return new Promise((resolve, reject) => {
            axios
                .get(`/api/task-management/skill/${skill_id}`)
                .then(response => {
                    resolve(response);
    ...
    fetchItemsBySkills({ commit }, items) {
        return new Promise((resolve, reject) => {
            axios
                .post(`/api/task-management/skills`, items)
                .then(response => {
    ...
    fetchItem(context, id) {
        return new Promise((resolve, reject) => {
            axios
                .get(`/api/task-management/show/${id}`)
                .then(response => {
                    resolve(response);
                })
                .catch(error => {
    ...
    uploadFile({ commit }, item) {
        return new Promise((resolve, reject) => {
            axios
                .post(
                    `/api/task-management/upload-file/${item.token}`,
                    item.files
                )
                .then(response => {
                    resolve(response);
    ...
    deleteFile({ commit }, id) {
        return new Promise((resolve, reject) => {
            axios
                .delete(`/api/task-management/delete-file/${id}`)
                .then(response => {
                    resolve(response);
                })
                .catch(error => {
    ...
    deleteFiles({ commit }, ids) {
        return new Promise((resolve, reject) => {
            axios
                .post(`/api/task-management/delete-files`, ids)
                .then(response => {
                    resolve(response);
                })
                .catch(error => {
