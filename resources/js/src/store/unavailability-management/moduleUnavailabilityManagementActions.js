...
export default {
    ...
    fetchItems({ commit }) {
        return new Promise((resolve, reject) => {
            axios.get('/api/unavailability-management/index')
                .then((response) => {
    ...
    updateItem({ commit }, item) {
        return new Promise((resolve, reject) => {
            axios.post(`/api/unavailability-management/update/${item.id}`, item)
                .then((response) => {
    ...
    removeItem({ commit }, id) {
        return new Promise((resolve, reject) => {
            axios.delete(`/api/unavailability-management/destroy/${id}`)
                .then((response) => {
