...
export default {
  ...
  data() {
    return {
      ...
      hours_type_names: ["Heures supplémentaires payées", "Utilisation heures supplémentaires", "Jours fériés", "Rendez-vous privé", "Congés payés", "Période de cours", "Arrêt de travail", "Autre..."],
