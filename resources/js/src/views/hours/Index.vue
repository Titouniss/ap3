    ...
    <div id="page-hours-list">
        ...
        <div class="vx-card p-6 mt-1">
            ...
            >
                <vs-col
                    v-if="
                        filters.user !== null && filters.period_type === 'year'
                    "
                    vs-w="4"
                    vs-type="flex"
                    vs-justify="center"
                    ...
                    {{
                        dealingHours.overtimes
                            ? Math.abs(dealingHours.overtimes)
                            : dealingHours.overtimes
                    }}</vs-col
                >
                <vs-col
                    ...
                    >Heures manquantes :
                    {{
                        dealingHours.missHours
                            ? Math.abs(dealingHours.missHours)
                            : dealingHours.missHours
                    }}</vs-col
                >
                <vs-col
                    ...
                    vs-justify="center"
                    vs-align="center"
                    >Heures récupérées / payées :
                    {{
                        dealingHours.usedHours
                            ? dealingHours.usedHours
                            : dealingHours.usedHours
                    }}</vs-col
                >
