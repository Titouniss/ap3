        ...
        <div class="vx-row">
          <div class="vx-col w-full">
            ...
            <vs-input
              ...
              class="w-full my-8"
              v-model="item.name"
              :success="item.name.length > 0 && errors.has('name')"
            ...
            <div class="w-full flex flex-row justify-between">
              ...
              <div class="flex flex-row justify-center">
                <vs-radio class="mx-3" v-model="item.type" vs-value="sql">
                  SQL
                </vs-radio>
                <vs-radio class="mx-3" v-model="item.type" vs-value="api">
                  API
                </vs-radio>
              </div>
            </div>
...
export default {
  ...
  computed: {
    validateForm() {
      return (
        !this.errors.any() && this.item.name != "" && this.item.company != null
      );
    },
    activePrompt: {
      get() {
