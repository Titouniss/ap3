      ...
      <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="12">
        <vx-card>
          ...
          >
                ...
                >
                  ...
                  >
                    <vs-input
                      ...
                      "
                      :danger="errors.has('host', 'step-1')"
                      :danger-text="errors.first('host', 'step-1')"
                    />
                  </vs-col>
                  <vs-col
                    vs-type="flex"
                  ...
                  >
                    <vs-input
                      ...
                      "
                      :danger="errors.has('port', 'step-1')"
                      :danger-text="errors.first('port', 'step-1')"
                    />
                  </vs-col>
                  <vs-col
                    vs-type="flex"
                  ...
                  >
                    <vs-input
                      ...
                      "
                      :danger="errors.has('charset', 'step-1')"
                      :danger-text="errors.first('charset', 'step-1')"
                    />
                  </vs-col>
                  <vs-col
                    vs-type="flex"
                  ...
                  >
                    <vs-input
                      ...
                      "
                      :danger="errors.has('database', 'step-1')"
                      :danger-text="errors.first('database', 'step-1')"
                    />
                  </vs-col>
                </vs-row>
                ...
                >
                  ...
                  >
                    <vs-input
                      ...
                      "
                      :danger="errors.has('username', 'step-1')"
                      :danger-text="errors.first('username', 'step-1')"
                    />
                  </vs-col>
                  <vs-col
                    vs-type="flex"
                  ...
                  >
                    <vs-input
                      ...
                      v-validate="
                        'min:8|max:50' +
                        (!connection.has_password ? '|required' : '')
                      "
                      name="password"
                      ...
                      "
                      :danger="errors.has('password', 'step-1')"
                      :danger-text="errors.first('password', 'step-1')"
                    />
                  </vs-col>
                  <vs-col
                    vs-type="flex"
                  ...
                  >
                    <vs-input
                      ...
                      v-model="connection.confirm_password"
                      @input="onConnectionInputChange"
                      class="w-full"
                      :success="
                        connection.confirm_password.length > 0 &&
                        !errors.has('confirm_password', 'step-1')
                      "
                      :danger="errors.has('confirm_password', 'step-1')"
                      :danger-text="errors.first('confirm_password', 'step-1')"
                    />
                  </vs-col>
                </vs-row>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <feather-icon
                          :icon="`${
                            dbConnection.test_passed ? 'Check' : 'X'
                          }Icon`"
                          svgClasses="h-8 w-8 text-white"
                        />
                      </div>
                      <span> Test de connexion réussi </span>
                    </div>
                    <vs-prompt
                      title="Test de connexion"
                      :color="connectionStatusColor"
                      :buttons-hidden="true"
                      :active.sync="dbConnection.prompt_active"
                    >
                      <div>
                        <div
                          id="connection-div"
                          class="vs-con-loading__container h-16"
                          v-if="dbConnection.is_testing"
                        ></div>
                        <div v-if="!dbConnection.is_testing">
                          <vs-row
                            vs-type="flex"
                            vs-justify="center"
                            vs-align="center"
                ...
                >
                  ...
                  >
                    <vs-input
                      ...
                      "
                      :danger="errors.has('url', 'step-1')"
                      :danger-text="errors.first('url', 'step-1')"
                    />
                  </vs-col>
                  <vs-col
                    vs-type="flex"
                  ...
                  >
                    <vs-input
                      ...
                      class="w-full"
                      :success="
                        connection.auth_headers.length > 0 &&
                        !errors.has('auth_headers', 'step-1')
                      "
                      :danger="errors.has('auth_headers', 'step-1')"
                      :danger-text="errors.first('auth_headers', 'step-1')"
                    />
                  </vs-col>
                </vs-row>
              </form>
            ...
            >
              <data-types ref="dataTypes" :module="item"></data-types>
            </tab-content>
          </form-wizard>
        </vx-card>
      </vs-col>
          ...
          if (result) {
            if (this.sqlMode && !this.dbConnection.test_passed) {
              this.errors.add({
                field: "dbTest",
                scope: "step-1",
                msg: "Vous devez tester la connexion avant de poursuivre",
              });
              reject("Error");
            } else {
      ...
      setTimeout(() => {
        ...
        this.$store
          ...
          .finally(() => {
            ...
            this.$vs.loading.close("#connection-div > .con-vs-loading");
          });
      }, 1000);
    },
    updateModule() {
      ...
      return this.$store
        .dispatch("moduleManagement/updateConnection", payload)
        .then((response) => {
          this.$vs.notify({
            title: "Succès",
    ...
    this.$store
      ...
      .then((data) => {
        ...
        this.connection = {
          ...
          driver: data.payload.connection.driver || "mysql",
          has_changes: false,
        };
