...
<template>
  <div class="h-screen flex w-full bg-img">
    ...
    >
      ...
      >Vous n'êtes pas autorisé à accéder à cette page !</h1>
      <p
        class="sm:mx-0 mx-4 sm:mb-12 mb-8 d-theme-text-inverse"
      >Contacter votre administrateur afin que celui-ci vous donne les droits nécessaires pour accéder à cette page.</p>
