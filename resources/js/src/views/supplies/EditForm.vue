...
<template>
    <vs-prompt
        title="Edition d'un approvisionnement"
...
export default {
    ...
    data() {
        return {
            itemLocal: Object.assign(
                {},
                this.$store.getters["supplyManagement/getItem"](this.itemId)
            )
        };
    },
    computed: {
        ...
        activePrompt: {
            ...
            set(value) {
                this.$store
                    .dispatch("supplyManagement/editItem", {})
                    .then(() => {})
                    .catch(err => {
                        console.error(err);
                    });
    ...
    methods: {
        ...
        submitItem() {
            this.$store
                .dispatch("supplyManagement/updateItem", this.itemLocal)
                .then(() => {
                    this.$vs.loading.close();
                    this.$vs.notify({
                        title: "Modification d'une approvisionnement",
