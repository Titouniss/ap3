  ...
  <div id="page-bug-list">
    <div class="vx-card p-6">
      <div class="px-4 pt-3 mb-6">
        <vs-button @click="addRecord" class="w-full">Remonter un bug</vs-button>
      </div>
        ...
        <vs-dropdown vs-trigger-click class="cursor-pointer">
          ...
          >
            <span class="mr-2">
              ...
              -
              {{
                bugsData.length - currentPage * paginationPageSize > 0
...
export default {
  ...
  created() {
    if(!this.isAdmin){
      ...
      this.$store
        .dispatch("bugManagement/fetchItems").catch((err) => {
          console.error(err);
        });
