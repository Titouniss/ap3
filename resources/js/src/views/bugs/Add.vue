...
export default {
    ...
    computed: {
        ...
        validateForm() {
            return (
                !this.errors.any() &&
                this.bug_data.module != "" &&
                this.bug_data.type != "" &&
                this.bug_data.description != ""
            );
        }
    },
    methods: {
        save_changes() {
            ...
            payload.company_id = this.$store.state.AppActiveUser.company
                ? this.$store.state.AppActiveUser.company.id
                : null;
            payload.role_id = this.$store.state.AppActiveUser.role
                ? this.$store.state.AppActiveUser.role.id
                : null;
            payload.status = "new";
