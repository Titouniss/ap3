...
export default {
  ...
  methods: {
    init () {
      this.itemLocal = Object.assign({}, this.$store.getters['workareaManagement/getItem'](this.itemId))
    },
    submitItem () {
      this.$store.dispatch('workareaManagement/updateItem', this.itemLocal)
      .then(() => { 
