          ...
          <div class="vx-row">
            ...
            <div class="vx-col flex-1" style="border-right: 1px solid #d6d6d6">
              ...
              <vs-input
                ...
                :color="!errors.has('stepName') ? 'success' : 'danger'"
              />
              <span
...
export default {
  ...
  data() {
    const item = JSON.parse(
      JSON.stringify(
        this.$store.getters["repetitiveTaskManagement/getItem"](this.itemId)
      )
    );
    return {
      itemLocal: item,
      token:
        item.token || "token_" + Math.random().toString(36).substring(2, 15),
