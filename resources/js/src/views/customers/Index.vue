        ...
        <div class="flex-grow">
          <vs-dropdown vs-trigger-click class="cursor-pointer">
            ...
            >
              <span
                class="mr-2"
              >{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ customersData.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : customersData.length }} of {{ customersData.length }}</span>
