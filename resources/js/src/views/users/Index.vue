<template>
    <div id="page-users-list">
        <div class="vx-card w-full p-6">
            <div class="px-6 pt-3 mb-6" v-if="authorizedToPublish">
                <vs-button @click="addRecord" class="w-full mb-2"
                    >Ajouter un utilisateur</vs-button
                >
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            gridApi: null,
            gridOptions: {
                localeText: { noRowsToShow: "Pas d'utilisateurs à afficher" }
            },
            defaultColDef: {
                sortable: true,
                resizable: true,
