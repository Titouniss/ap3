const errorMessage = {
    custom: {
        ...
        skills: {
            required:
                "Une tache doit être rattachée au minimum à une compétence"
        },
        workarea: {
            required:
                "Vous devez selectionner un pôle de production lorsqu'une ou plusieurs compétences sont selectionnées"
        },
        userId: {
