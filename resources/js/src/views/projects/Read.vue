...
<template>
  <div id="page-project-view">
    ...
    >
      <span
        >Project record with id: {{ $route.params.projectId }} not found.</span
      >
      <span>
        <span>Check</span>
        <router-link
    ...
    <div id="project-data" v-if="project_data">
      <vx-card title="Informations" class="mb-base">
          ...
          <div class="vx-col flex-1" id="account-info-col-1">
            <table>
              ...
              <tr
                ...
                "
              >
                <td class="font-semibold">Date de lancement :</td>
          ...
          <div class="vx-col flex-1" id="account-info-col-2">
            <table>
              <tr>
                ...
                <td>
                  {{ lateDayData > 0 ? lateDayData : -lateDayData }}
                  jours
                </td>
              </tr>
              <tr>
        ...
        <div
          v-if="project_data.documents && project_data.documents.length > 0"
          class="mt-4"
        >
