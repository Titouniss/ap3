...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #222222;">
                            ...
                            <tr>
                                <td valign="top" width="33.333%">
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td style="text-align: left; padding-right: 10px;">
                                                <p>&copy; Numidev 2020. Tous droits réservés</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td style="text-align: right; padding-left: 5px; padding-right: 5px;">
                                                <p><a href="#" style="color: rgba(255,255,255,.4);">Se désinscrire</a>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-23581568-13"
        type="e8c02711cca11371d6390aa9-text/javascript"></script>
    <script type="e8c02711cca11371d6390aa9-text/javascript">
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="e8c02711cca11371d6390aa9-|49" defer=""></script>
</body>
