...
class SupplyPolicy extends BasePolicy
{
    ...
    {
        parent::__construct('supplies', 'company_id');
    }
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Supply  $item
     * @return boolean
     */
    public function show(User $user, Supply $item)
    {
     ...
     * @return boolean
     */
    public function edit(User $user, Supply $item)
    {
     ...
     * @return boolean
     */
    public function delete(User $user, Supply $item)
    {
