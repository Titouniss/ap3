...
class SkillPolicy extends BasePolicy
{
    ...
    {
        parent::__construct('skills', 'company_id');
    }
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Skill  $item
     * @return boolean
     */
    public function show(User $user, Skill $item)
    {
     ...
     * @return boolean
     */
    public function edit(User $user, Skill $item)
    {
     ...
     * @return boolean
     */
    public function delete(User $user, Skill $item)
    {
