...
class HoursPolicy extends BasePolicy
{
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Hours  $item
     * @return boolean
     */
    public function show(User $user, Hours $item)
    {
     ...
     * @return boolean
     */
    public function edit(User $user, Hours $item)
    {
     ...
     * @return boolean
     */
    public function delete(User $user, Hours $item)
    {
